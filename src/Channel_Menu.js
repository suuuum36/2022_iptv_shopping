...
const productArray_2 = [
    ...
    {url: require('./img/channel_menu/product_5.png'), url_logo: logo_cj, live_status: '예정', live_color:'reserved', live_date: '08/26', live_day: '(금)', live_time : '19:49', name : '스마트카라 음식물처리기(모던그레이_PCS400SA)', sale_num:'10%', price:'773,100', tag:'무이자'},
