...
const carousel_items = [
    {index: 1, src: '/img/vidoe_sample.mp4', logo: '/img/logo_gs_shop_2.png', price_original: '75,400', price_discount: '30%', price_final:'58,000', title:'[런칭가 99,900원] 김서룡 시그니처 오간자 봄버 재킷', poster: '/img/img_item_sample_440_1.png' },
    {index: 2, src: '/img/vidoe_sample.mp4', logo: '/img/logo_gs_shop_2.png', price_original: '75,400', price_discount: '30%', price_final:'58,000', title:'bbbbbb', poster: '/img/img_item_sample_440_1.png' },
    {index: 3, src: '/img/vidoe_sample.mp4', logo: '/img/logo_gs_shop_2.png', price_original: '75,400', price_discount: '30%', price_final:'58,000', title:'cccccc', poster: '/img/img_item_sample_440_1.png' },
]
            ...
            <div className="main_content_2" >
                <div className="module_a2 module_play_top3">
                    ...
                    <div className="wrapper_content wrapper_controllable">
                        {video_infos.map((video_info, index) => <ModuleVideo key={video_info.index} index={video_info.index} src={video_info.src} logo={video_info.logo} price_original={video_info.price_original} price_discount={video_info.price_discount} price_final={video_info.price_final} title={video_info.title} />)}
                    </div>
                </div> 
                <div className="module_a2 module_item_expand">
                    ...
                    <ul className="carousel wrapper_controllable">
                        {carousel_items.map(carousel_item => <ModuleCarouselItem key={carousel_item.index} src={carousel_item.src} logo={carousel_item.logo} price_original={carousel_item.price_original} price_discount={carousel_item.price_discount} price_final={carousel_item.price_final} title={carousel_item.title} poster={carousel_item.poster} />)}
                    </ul>
                </div>
            </div>
        </>
